const LibertyStatueBackground = () => {
    return ( 
        <div className="liberty-statue-background">
            <div className="container">
                <div className="content-liberty-statue-background position-relative">
...
export default LibertyStatueBackground;